      ...
      <main className="cadastro-page">
        <div className="cadastro-card cadastro-card--wide">
          ...
          <div className="card-header">
            ...
            <h1 className="card-title">Cadastro de Banda</h1>
            <p className="card-subtitle">Preencha os dados da sua banda</p>
          </div>
            ...
            <form className="cadastro-form" onSubmit={handleSubmit} noValidate>
              ...
              <div className="form-row">
                ...
                <div className="field-group">
                  ...
                  <div className="input-wrapper">
                    <select id="estadoCriacao" name="estadoCriacao" className="field-input no-icon" value={form.estadoCriacao} onChange={handleChange}>
