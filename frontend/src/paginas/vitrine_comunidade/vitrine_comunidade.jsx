        ...
        <div className={styles['vc-layout']}>
          ...
          <div className={styles['vc-col-left']}>
            ...
            <div className={cn(styles['vc-card'], styles['vc-profile-card'])}>
              <div className={styles['vc-cover']}>
                {comunidade.cover ? (
                  <img src={comunidade.cover} alt="Capa" className={styles['vc-cover-img']} />
                ) : (
              ...
              <div className={styles['vc-avatar-row']}>
                <div className={styles['vc-avatar-wrap']}>
                  ...
                  <div className={styles['vc-avatar-edit']}>
                    <svg viewBox="0 0 24 24">
              ...
              <div className={styles['vc-profile-info']}>
                <div className={styles['vc-community-name']}>{comunidade.nome}</div>
                ...
                <div className={styles['vc-profile-actions']}>
                  <button
                  ...
                  <button className={styles['vc-btn-contato']}>Contato</button>
                </div>
              </div>
            </div>
                ...
                {abaAtiva === 'sobre' && (
                  <>
                    ...
                    <div className={styles['vc-meta-list']}>
                      ...
                      <div className={styles['vc-social-icons']} style={{ paddingLeft: '24px' }}>
                        {[
                          ...
                          <div key={rede.label} className={styles['vc-social-icon']} title={rede.label}>
                            <svg viewBox="0 0 24 24">
                              <path d={rede.path} />
                            </svg>
                          </div>
            ...
            <div className={cn(styles['vc-card'], styles['vc-ratings-card'])}>
              <div className={styles['vc-ratings-header']}>
                <span className={styles['vc-ratings-title']}>Avaliações da comunidade</span>
                <a href="#avaliacoes" className={styles['vc-ver-todas']}>Ver todas</a>
              </div>
              ...
              <div className={styles['vc-rating-big']}>
                ...
                <div className={styles['vc-rating-info']}>
                  ...
                  <span className={styles['vc-rating-count']}>Baseado em {stats.totalAvaliacoes} avaliações</span>
                </div>
              </div>

              <div className={styles['vc-rating-bars']}>
                {[5, 4, 3, 2, 1].map((n) => (
          ...
          <div className={styles['vc-col-right']}>
            ...
            <div className={cn(styles['vc-card'], styles['vc-gallery-card'])}>
              <div className={styles['vc-gallery-header']}>Galeria</div>
              <div className={styles['vc-gallery-grid']}>
                {galeria.slice(0, 6).map((img, i) => (
                  <div key={i} className={styles['vc-gallery-item']}>
                    {img ? (
                      <img src={img} alt={`Foto ${i + 1}`} />
                    ) : (
                      <div className={styles['vc-gallery-placeholder']}>
                        <svg viewBox="0 0 24 24">
                          <rect x="3" y="3" width="18" height="18" rx="2" />
                          <circle cx="8.5" cy="8.5" r="1.5" />
                          <polyline points="21 15 16 10 5 21" />
            ...
            <div className={cn(styles['vc-card'], styles['vc-events-card'])}>
              ...
              <div className={styles['vc-events-list']}>
                {eventos.map((ev) => (
                  <Link to={`/evento/${ev.id}`} key={ev.id} className={styles['vc-event-item']}>
                    {ev.image ? (
                    ...
                    <div className={styles['vc-event-info']}>
                      ...
                      <div className={styles['vc-event-confirmados']}>
                        <svg viewBox="0 0 24 24">
                    ...
                    <div className={styles['vc-event-status-area']}>
                      ...
                      <div className={cn(styles['vc-event-countdown'], ev.status === 'andamento' && styles['vc-event-countdown--hoje'])}>
